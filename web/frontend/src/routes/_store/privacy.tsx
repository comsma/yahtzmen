...
function Privacy() {
    return (
        <Container
            className={
                'flex flex-col gap-8 px-4 py-8 leading-relaxed text-secondary'
            }
        >
            <div>
                <h1 className={'text-2xl font-bold'}>
                    Privacy Policy of Yahtzmen Furnishings
                </h1>

                <p>
                    Yahtzmen Furnishings operates the Yahtzmen.com website,
                ...
                <p>
                    ...
                    the Yahtzmen Furnishings website.
                </p>
                ...
                <p>
                    ...
                    Yahtzmen.com, unless otherwise defined in this Privacy
                    Policy.
                </p>
            </div>
            <div>
            ...
            <div>
                ...
                <p>
                    ...
                    <a href={'mailto:info@yahtzmen.com'}>info@yahtzmen.com</a>.
                </p>
            </div>
        </Container>
    )
