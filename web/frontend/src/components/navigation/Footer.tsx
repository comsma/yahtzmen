...
const navigation = {
    main: [
        ...
        { name: 'Store Management', href: '/admin' },
    ],
    social: [
        {
            name: 'Instagram',
...
export default function Footer() {
    return (
        <footer className="mb-0 bg-secondary text-primary">
            <div className="mx-auto flex max-w-7xl flex-col items-center gap-4 overflow-hidden py-8 lg:flex-row">
                <nav
                ...
                <p className="lg:ml-auto">
                    &copy; 2023 Yahtzmen Furnishings All rights reserved.
                </p>
            </div>
        </footer>
    )
